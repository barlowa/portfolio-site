...
import { Project, HeroSection, ImageSection, BullettedSection, BoxSection } from '../Organisms'
import { Title, Highlight, Divider } from '../Atoms'
import { useSmoothScrolling, useFetch } from '../Hooks'
import { CloudinaryProps } from '../@types'
...
const Home = () => {
	...
	useSmoothScrolling({ hash, key })

	const elitegaragesGallery = useFetch<CloudinaryResponse>(
		useMemo(() => 'https://res.cloudinary.com/dyfxobpyc/image/list/elitegarages.json', [])
	)

	const infundGallery = useFetch<CloudinaryResponse>(
		'https://res.cloudinary.com/dyfxobpyc/image/list/infund.json'
	)
		...
		<>
			...
			<Divider id="projects">
				...
				<Project
					title="Elite Garages"
					image={elitegarages}
					gallery={elitegaragesGallery?.response?.resources}
				>
					<p>
						Elite garages are a chain operating across the south-east of England, providing a wide range
						of automotive services.
					</p>
					<p>
						The aim of this project was to introduce more online business. To achieve this goal,
						initially the main focus area was creating a platform which allows customers to buy tyres
						online to be fitted at any of the Elite Garages branches.
					</p>
					<p>
						The sites functionality was then extended to allow customers to book an MOT and book a
						vehicle service or inspection online.
					</p>
					<p>
			...
			<Divider id="about">
				<ImageSection title="More About Me" image={me}>
					...
					<p>
						I value simple content structure, clean design patterns, and I enjoy bringing ideas to life
						in the browser.
					</p>
					<p>
			...
			<Divider id="uses">
				<BoxSection title="uses">
					<p>
						This is a short list of the hardware and software I own or use on a regular basis. Based on
						the wes-bos{' '}
				...
				<BullettedSection title="Text Editor">
					...
					<li>
						<Highlight>Bracket Pair Colorizer:</Highlight> This extension makes it very easy to
						distinguish where a code block ends by assigning the same colour to the opening and closing
						brackets.
					</li>
					<li>
						<Highlight>Prettier:</Highlight> I have learnt to love prettier. I used to absolutely hate
						the way it changed my code. But now I am used to it, my code has never looked more uniform.
						I have it running on save and it almost takes formatting out of the equation which gives you
						more brain bandwidth to think about your actual code.
					</li>
					<li>
				...
				<BullettedSection title="Development">
					<li>
						<Highlight>Java Script:</Highlight> This is my main language these days, but React is the
						main library I use to build anything front-end related at the moment. I am interested in VUE
						and I have dabbled with angular before, but I prefer Reacts less opinionated approach. I am
						also interested in branching out and learning swift.
					</li>
					<li>
						<Highlight>CSS:</Highlight> I love CSS! Therefore, I love for Styled Components! I like the
						way you can directly make changes to CSS in the file you are working on, or export it and
						use it anywhere you want! Also, not having to compile the CSS separately is nice.
					</li>
					<li>
						...
						something like Reacts’ context API steps in; with the addition of the useContext hook, I
				...
				<BullettedSection title="Desk Set Up">
					<li>
						...
						that I am a lot more productive with more desktop space, since it means I don’t need to
						scroll as much through my code, especially if the monitor is in portrait mode; the novelty
						wore off that quite quickly though.
					</li>
					<li>
						<Highlight>Laptop:</Highlight>My current laptop is a Macbook pro 15 inch mid 2015 2.5ghz
						16gb ram 512gb SSD. This laptop has been a trooper, it has survived a full bottle of peroni
						over the keyboard with no ill effects (wasn’t even my fault, I had to tear it down and clean
						it though). I don’t see the need to replace it just yet, it still does everything I need it
						to do. The 16 inch macbook is looking like a good upgrade in a few years, especially since
						the keyboard doesn’t break now.
					</li>
				</BullettedSection>
			</Divider>
		</>
